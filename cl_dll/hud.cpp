...
void CHud::VidInit()
{
	...
	// get the maximum sprite resolution from the sprite list, to optionally support hl25 resolutions
	m_iMaxRes = 640;
	auto* pSpriteList = m_pSpriteList ? m_pSpriteList : SPR_GetList("sprites/hud.txt", &m_iSpriteCountAllRes);
	if (pSpriteList)
	{
