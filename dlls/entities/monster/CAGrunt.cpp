 ...
 * @return number of events handled, 0 if none.
 */
...
/**
 * Standoff schedule. Used in combat when a monster is hiding in cover or the enemy has moved out of sight.
...
/**
 * Take cover from enemy! Tries lateral cover before node cover!
 */
...
/**
 * FCanCheckAttacks - this is overridden for alien grunts because they can use their smart weapons against unseen enemies.
...
/**
 * Decides which type of schedule best suits the monster's current state and conditions.
